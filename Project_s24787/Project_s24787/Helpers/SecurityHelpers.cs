...
namespace Project_s24787.Helpers;
...
public class SecurityHelpers
{
    ...
    public static string GenerateRefreshToken(IConfiguration configuration)
    {
        ...
        return new JwtSecurityTokenHandler().WriteToken(refToken);
    }

    public static bool IsTokenExpired(string token)
    {
        return new JwtSecurityTokenHandler().ReadToken(token).ValidTo < DateTime.Now;
    }
}